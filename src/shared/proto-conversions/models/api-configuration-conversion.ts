...
export function convertApiConfigurationToProto(config: ApiConfiguration): ProtoApiConfiguration {
	return {
		...
		gptrouterOauthBaseUrl: config.gptrouterOAuthBaseUrl,
		gptrouterOauthTokenUrl: config.gptrouterOAuthTokenUrl,
		gptrouterOauthClientId: config.gptrouterOAuthClientId,
		gptrouterOauthAuthorizeUrl: config.gptrouterOAuthAuthorizeUrl,
		gptrouterOauthRedirectUri: config.gptrouterOAuthRedirectUri,
...
export function convertProtoToApiConfiguration(protoConfig: ProtoApiConfiguration): ApiConfiguration {
	return {
		...
		gptrouterOAuthBaseUrl: protoConfig.gptrouterOauthBaseUrl,
		gptrouterOAuthTokenUrl: protoConfig.gptrouterOauthTokenUrl,
		gptrouterOAuthClientId: protoConfig.gptrouterOauthClientId,
		gptrouterOAuthAuthorizeUrl: protoConfig.gptrouterOauthAuthorizeUrl,
		gptrouterOAuthRedirectUri: protoConfig.gptrouterOauthRedirectUri,
