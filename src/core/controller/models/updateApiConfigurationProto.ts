...
export async function updateApiConfigurationProto(
	...
	try {
		...
		// Must use convertProtoToApiConfiguration (not raw proto spread): proto field names
		// differ from persisted Settings keys (e.g. gptrouterOauthAuthorizeUrl vs gptrouterOAuthAuthorizeUrl).
		// Raw spread caused OAuth debug overrides to be dropped by setApiConfiguration.
